        ...
        class << self
          ...
          def compute_sizes(info)
            ...
            @fact_list[:mountpoints][info.last].merge!(
              ...
              available: FactsUtils::Converter.bytes_to_human_readable(available_bytes),
              used: FactsUtils::Converter.bytes_to_human_readable(used_bytes),
              size: FactsUtils::Converter.bytes_to_human_readable(size_bytes)
            )
          end
        end
      end
