        ...
        class << self
          ...
          def read_mounts # rubocop:disable Metrics/AbcSize
            ...
            FilesystemHelper.read_mountpoints.each do |fs|
              ...
              size = Facter::FactsUtils::Converter.bytes_to_human_readable(size_bytes)
              available = Facter::FactsUtils::Converter.bytes_to_human_readable(available_bytes)
              used = Facter::FactsUtils::Converter.bytes_to_human_readable(used_bytes)
